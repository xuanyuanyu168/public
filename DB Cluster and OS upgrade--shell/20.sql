ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('execution', 'max_concurrency') = '19' WITH RECONFIGURE;                                               

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('execution', 'max_concurrency_hint') = '10' WITH RECONFIGURE;                                           

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('parallel', 'num_cores') = '10' WITH RECONFIGURE;                                             

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('execution', 'default_statement_concurrency_limit') = '10' WITH RECONFIGURE;  

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('persistence', 'max_gc_parallelity') = '10' WITH RECONFIGURE;
