...
ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('parallel', 'num_cores') = '4' WITH RECONFIGURE;                                             

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('execution', 'default_statement_concurrency_limit') = '4' WITH RECONFIGURE;  

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('persistence', 'max_gc_parallelity') = '4' WITH RECONFIGURE;
