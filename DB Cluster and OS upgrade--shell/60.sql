ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('execution', 'max_concurrency') = '57' WITH RECONFIGURE;                                               

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('execution', 'max_concurrency_hint') = '30' WITH RECONFIGURE;                                           

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('parallel', 'num_cores') = '30' WITH RECONFIGURE;                                             

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('execution', 'default_statement_concurrency_limit') = '30' WITH RECONFIGURE;  

ALTER SYSTEM ALTER CONFIGURATION ('global.ini', 'SYSTEM') SET ('persistence', 'max_gc_parallelity') = '30' WITH RECONFIGURE;
